...
/*ydb.pushdown('->')*/ 
select tradetime, amtfloat from blocksort_ydb  
 order by tradetime,amtfloat limit 1000 
/*('<-')pushdown.ydb*/;


/*ydb.pushdown('->')*/ 
select tradetime, amtfloat from blocksort_ydb where 
...
/*ydb.pushdown('->')*/ 
select amtint, amtfloat from blocksort_ydb  
 order by amtint,amtfloat limit 1000 
/*('<-')pushdown.ydb*/;


/*ydb.pushdown('->')*/ 
select amtint, amtfloat from blocksort_ydb where 
...
/*ydb.pushdown('->')*/ 
select amtdouble, amtfloat from blocksort_ydb  
 order by amtdouble,amtfloat limit 1000 
/*('<-')pushdown.ydb*/;


/*ydb.pushdown('->')*/ 
select amtdouble, amtfloat from blocksort_ydb where 
...
/*ydb.pushdown('->')*/ 
select amtfloat, tradetime from blocksort_ydb  
 order by amtfloat,tradetime limit 1000 
/*('<-')pushdown.ydb*/;


/*ydb.pushdown('->')*/ 
select amtfloat, tradetime from blocksort_ydb where 
