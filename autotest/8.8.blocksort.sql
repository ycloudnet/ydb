...
/*ydb.pushdown('->')*/ 
select tradetime, amtfloat from blocksort_ydb  where amtfloat>='0.003' and amtfloat<='0.009'
 order by tradetime,amtfloat limit 1000 
/*('<-')pushdown.ydb*/;


/*ydb.pushdown('->')*/ 
select tradetime, amtfloat from blocksort_ydb where amtfloat>='0.003' and amtfloat<='0.009' and  
...
/*ydb.pushdown('->')*/ 
select amtint, amtfloat from blocksort_ydb  where amtfloat>='0.003' and amtfloat<='0.009' 
 order by amtint,amtfloat limit 1000 
/*('<-')pushdown.ydb*/;


/*ydb.pushdown('->')*/ 
select amtint, amtfloat from blocksort_ydb where amtfloat>='0.003' and amtfloat<='0.009' and  
...
/*ydb.pushdown('->')*/ 
select amtdouble, amtfloat from blocksort_ydb  where amtfloat>='0.003' and amtfloat<='0.009' 
 order by amtdouble,amtfloat limit 1000 
/*('<-')pushdown.ydb*/;


/*ydb.pushdown('->')*/ 
select amtdouble, amtfloat from blocksort_ydb where amtfloat>='0.003' and amtfloat<='0.009' and  
...
/*ydb.pushdown('->')*/ 
select amtfloat, tradetime from blocksort_ydb  where amtfloat>='0.003' and amtfloat<='0.009' 
 order by amtfloat,tradetime limit 1000 
/*('<-')pushdown.ydb*/;


/*ydb.pushdown('->')*/ 
select amtfloat, tradetime from blocksort_ydb where amtfloat>='0.003' and amtfloat<='0.009' and  
