...
select  ca_zip, ca_county, sum(ws_sales_price)
 from
    ...
    JOIN customer_tcpds customer ON web_sales.ws_bill_customer_sk = customer.c_customer_sk
    JOIN customer_address_tcpds customer_address ON customer.c_current_addr_sk = customer_address.ca_address_sk 
