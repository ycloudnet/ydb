...
select 'call_center_tcpydb', 'ydb_default_partion', '',
    YROW(
        'cc_call_center_sk'               ,cc_call_center_sk                                                          
,       'cc_call_center_id'               ,cc_call_center_id                                                          
,       'cc_rec_start_date'               ,cc_rec_start_date                                                          
,       'cc_rec_end_date'                 ,cc_rec_end_date                                                            
,       'cc_closed_date_sk'               ,cc_closed_date_sk                                                          
,       'cc_open_date_sk'                 ,cc_open_date_sk                                                            
,       'cc_name'                         ,cc_name                                                                    
,       'cc_class'                        ,cc_class                                                                   
,       'cc_employees'                    ,cc_employees                                                               
,       'cc_sq_ft'                        ,cc_sq_ft                                                                   
,       'cc_hours'                        ,cc_hours                                                                   
...
from call_center_tcpds;
                                                                           
                                                                           
                                                                           
                                                                           
insert overwrite table ydbpartion
select 'catalog_page_tcpydb', 'ydb_default_partion', '',
    YROW(
        'cp_catalog_page_sk'              ,cp_catalog_page_sk                                                         
,       'cp_catalog_page_id'              ,cp_catalog_page_id                                                         
,       'cp_start_date_sk'                ,cp_start_date_sk                                                           
,       'cp_end_date_sk'                  ,cp_end_date_sk                                                             
,       'cp_department'                   ,cp_department                                                              
,       'cp_catalog_number'               ,cp_catalog_number                                                          
,       'cp_catalog_page_number'          ,cp_catalog_page_number                                                     
,       'cp_description'                  ,cp_description                                                             
,       'cp_type'                         ,cp_type                                                                    
    )                                                                          
from catalog_page_tcpds;
                                                                           
                                                                           
                                                                           
                                                                           
insert overwrite table ydbpartion
select 'catalog_returns_tcpydb', 'ydb_default_partion', '',
    YROW(
...
,       'cr_store_credit'                 ,cr_store_credit                                                            
,       'cr_net_loss'                     ,cr_net_loss                                                                
    )                                                                          
from catalog_returns_tcpds;
                                                                           
                                                                           
                                                                           
                                                                           
insert overwrite table ydbpartion
select 'catalog_sales_tcpydb', 'ydb_default_partion', '',
    YROW(
...
insert overwrite table ydbpartion
select 'customer_address_tcpydb', 'ydb_default_partion', '',
    YROW(
...
from customer_address_tcpds;
                                                                           
                                                                           
                                                                           
                                                                           
insert overwrite table ydbpartion
select 'customer_demographics_tcpydb', 'ydb_default_partion', '',
    YROW(
        'cd_demo_sk'                      ,cd_demo_sk                                                                 
,       'cd_gender'                       ,cd_gender                                                                  
,       'cd_marital_status'               ,cd_marital_status                                                          
,       'cd_education_status'             ,cd_education_status                                                        
,       'cd_purchase_estimate'            ,cd_purchase_estimate                                                       
,       'cd_credit_rating'                ,cd_credit_rating                                                           
,       'cd_dep_count'                    ,cd_dep_count                                                               
,       'cd_dep_employed_count'           ,cd_dep_employed_count                                                      
,       'cd_dep_college_count'            ,cd_dep_college_count                                                       
    )                                                                          
from customer_demographics_tcpds;
                                                                           
                                                                           
                                                                           
                                                                           
insert overwrite table ydbpartion
select 'customer_tcpydb', 'ydb_default_partion', '',
    YROW(
...
,       'c_first_shipto_date_sk'          ,c_first_shipto_date_sk                                                     
,       'c_first_sales_date_sk'           ,c_first_sales_date_sk                                                      
,       'c_salutation'                    ,c_salutation                                                               
,       'c_first_name'                    ,c_first_name                                                               
,       'c_last_name'                     ,c_last_name                                                                
,       'c_preferred_cust_flag'           ,c_preferred_cust_flag                                                      
...
,       'c_last_review_date'              ,c_last_review_date                                                         
    )                                                                          
from customer_tcpds;
...
insert overwrite table ydbpartion
select 'date_dim_tcpydb', 'ydb_default_partion', '',
    YROW(
        'd_date_sk'                       ,d_date_sk                                                                  
,       'd_date_id'                       ,d_date_id                                                                  
,       'd_date'                          ,d_date                                                                     
...
,       'd_qoy'                           ,d_qoy                                                                      
,       'd_fy_year'                       ,d_fy_year                                                                  
,       'd_fy_quarter_seq'                ,d_fy_quarter_seq                                                           
,       'd_fy_week_seq'                   ,d_fy_week_seq                                                              
,       'd_day_name'                      ,d_day_name                                                                 
,       'd_quarter_name'                  ,d_quarter_name                                                             
,       'd_holiday'                       ,d_holiday                                                                  
,       'd_weekend'                       ,d_weekend                                                                  
,       'd_following_holiday'             ,d_following_holiday                                                        
,       'd_first_dom'                     ,d_first_dom                                                                
,       'd_last_dom'                      ,d_last_dom                                                                 
,       'd_same_day_ly'                   ,d_same_day_ly                                                              
,       'd_same_day_lq'                   ,d_same_day_lq                                                              
,       'd_current_day'                   ,d_current_day                                                              
,       'd_current_week'                  ,d_current_week                                                             
,       'd_current_month'                 ,d_current_month                                                            
,       'd_current_quarter'               ,d_current_quarter                                                          
,       'd_current_year'                  ,d_current_year                                                             
    )                                                                          
from date_dim_tcpds;
...
insert overwrite table ydbpartion
select 'household_demographics_tcpydb', 'ydb_default_partion', '',
    YROW(
...
from household_demographics_tcpds;
                                                                           
                                                                           
                                                                           
                                                                           
insert overwrite table ydbpartion
select 'income_band_tcpydb', 'ydb_default_partion', '',
    YROW(
        'ib_income_band_sk'               ,ib_income_band_sk                                                          
,       'ib_lower_bound'                  ,ib_lower_bound                                                             
,       'ib_upper_bound'                  ,ib_upper_bound                                                             
    )                                                                          
from income_band_tcpds;
                                                                           
                                                                           
                                                                           
                                                                           
insert overwrite table ydbpartion
select 'inventory_tcpydb', 'ydb_default_partion', '',
    YROW(
...
from inventory_tcpds;
                                                                           
                                                                           
                                                                           
                                                                           
insert overwrite table ydbpartion
select 'item_tcpydb', 'ydb_default_partion', '',
    YROW(
        'i_item_sk'                       ,i_item_sk                                                                  
,       'i_item_id'                       ,i_item_id                                                                  
,       'i_rec_start_date'                ,i_rec_start_date                                                           
,       'i_rec_end_date'                  ,i_rec_end_date                                                             
...
insert overwrite table ydbpartion
select 'promotion_tcpydb', 'ydb_default_partion', '',
    YROW(
        'p_promo_sk'                      ,p_promo_sk                                                                 
,       'p_promo_id'                      ,p_promo_id                                                                 
...
from promotion_tcpds;
                                                                           
                                                                           
                                                                           
                                                                           
insert overwrite table ydbpartion
select 'reason_tcpydb', 'ydb_default_partion', '',
    YROW(
        'r_reason_sk'                     ,r_reason_sk                                                                
,       'r_reason_id'                     ,r_reason_id                                                                
,       'r_reason_desc'                   ,r_reason_desc                                                              
    )                                                                          
from reason_tcpds;
...
insert overwrite table ydbpartion
select 'ship_mode_tcpydb', 'ydb_default_partion', '',
    YROW(
        'sm_ship_mode_sk'                 ,sm_ship_mode_sk                                                            
,       'sm_ship_mode_id'                 ,sm_ship_mode_id                                                            
,       'sm_type'                         ,sm_type                                                                    
,       'sm_code'                         ,sm_code                                                                    
,       'sm_carrier'                      ,sm_carrier                                                                 
,       'sm_contract'                     ,sm_contract                                                                
    )                                                                          
from ship_mode_tcpds;
                                                                           
                                                                           
                                                                           
                                                                           
insert overwrite table ydbpartion
select 'store_returns_tcpydb', 'ydb_default_partion', '',
    YROW(
...
from store_returns_tcpds;
                                                                           
                                                                           
                                                                           
                                                                           
insert overwrite table ydbpartion
select 'store_sales_tcpydb', 'ydb_default_partion', '',
    YROW(
...
insert overwrite table ydbpartion
select 'store_tcpydb', 'ydb_default_partion', '',
    YROW(
        's_store_sk'                      ,s_store_sk                                                                 
,       's_store_id'                      ,s_store_id                                                                 
,       's_rec_start_date'                ,s_rec_start_date                                                           
,       's_rec_end_date'                  ,s_rec_end_date                                                             
,       's_closed_date_sk'                ,s_closed_date_sk                                                           
...
,       's_tax_precentage'                ,s_tax_precentage                                                           
    )                                                                          
from store_tcpds;
...
insert overwrite table ydbpartion
select 'time_dim_tcpydb', 'ydb_default_partion', '',
    YROW(
        't_time_sk'                       ,t_time_sk                                                                  
,       't_time_id'                       ,t_time_id                                                                  
,       't_time'                          ,t_time                                                                     
...
,       't_am_pm'                         ,t_am_pm                                                                    
,       't_shift'                         ,t_shift                                                                    
,       't_sub_shift'                     ,t_sub_shift                                                                
,       't_meal_time'                     ,t_meal_time                                                                
    )                                                                          
from time_dim_tcpds;
...
insert overwrite table ydbpartion
select 'warehouse_tcpydb', 'ydb_default_partion', '',
    YROW(
        'w_warehouse_sk'                  ,w_warehouse_sk                                                             
,       'w_warehouse_id'                  ,w_warehouse_id                                                             
...
from warehouse_tcpds;
                                                                           
                                                                           
                                                                           
                                                                           
insert overwrite table ydbpartion
select 'web_page_tcpydb', 'ydb_default_partion', '',
    YROW(
        'wp_web_page_sk'                  ,wp_web_page_sk                                                             
,       'wp_web_page_id'                  ,wp_web_page_id                                                             
,       'wp_rec_start_date'               ,wp_rec_start_date                                                          
,       'wp_rec_end_date'                 ,wp_rec_end_date                                                            
...
insert overwrite table ydbpartion
select 'web_returns_tcpydb', 'ydb_default_partion', '',
    YROW(
...
from web_returns_tcpds;
                                                                           
                                                                           
                                                                           
                                                                           
insert overwrite table ydbpartion
select 'web_sales_tcpydb', 'ydb_default_partion', '',
    YROW(
...
insert overwrite table ydbpartion
select 'web_site_tcpydb', 'ydb_default_partion', '',
    YROW(
        'web_site_sk'                     ,web_site_sk                                                                
,       'web_site_id'                     ,web_site_id                                                                
,       'web_rec_start_date'              ,web_rec_start_date                                                         
,       'web_rec_end_date'                ,web_rec_end_date                                                           
,       'web_name'                        ,web_name                                                                   
...
,       'web_market_manager'              ,web_market_manager                                                         
